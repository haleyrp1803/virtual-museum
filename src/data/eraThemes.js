...
export const DESIGN_PACKS = [
  ...
  },
  {
    ...
    status: 'live development sample active; typography provisional; final lesson use deferred',
  ...
  },
  {
    ...
    status: 'live conclusion design sample active; final content deferred',
  ...
  },
  {
    ...
    status: 'live development transition active; final lesson use deferred',
